...
val ARTIFACT_ID: String = "Kdux-gson"
val PUBLICATION_NAME = "KduxGson"
            ...
            publications {
                ...
                create<MavenPublication>(PUBLICATION_NAME) {
                    ...
                    pom {
                        name = "Kdux-gson"
                        description = """
                                Kdux-gson is an add-on to the Kdux library to add built-in support for Gson serialization.
                            """.trimIndent()
