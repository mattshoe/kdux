...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.android:1.0.7")
}
```
...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.room:1.0.7")
}
```
...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.realm:1.0.7")
}
```
...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.kotlinx-serialization:1.0.7")
}
```
...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.gson:1.0.7")
}
```
...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.protobuf:1.0.7")
}
```
...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.moshi:1.0.7")
}
```
...
```kotlin
dependencies {
    implementation("org.mattshoe.shoebox:Kdux.jackson:1.0.7")
}
```
